...
export default function ArticleHeader() {
  return (
    <>
      <div className="article-header flex flex-row flex-nowrap justify-start align-center mb-6">
        <div className="article-author flex-auto flex flex-row flex-wrap justify-start align-stretch">
          <div className="flex-none w-[48px] mr-3">
            <img className="rounded-full" src="james-t.jpeg" alt="James Tombs" />
          </div>
          <div className="text-gray-400">
            <div className="text-gray-600">James Tombs</div>
            <div className="text-sm">Nov 16 <span className="rounded-full bg-gray-400 w-[2px] h-[2px] inline-block my-1 mx-1"></span> 5 min read <span className="rounded-full bg-gray-400 w-[2px] h-[2px] inline-block my-1 mx-1"></span> <button className="text-green-600"><svg className="inline-block mb-1 fill-green-600" width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm2.8 8.51l-3.69 2.46a.62.62 0 0 1-.96-.5V5.53a.62.62 0 0 1 .96-.51l3.7 2.46a.62.62 0 0 1 0 1.02z"></path></svg> Listen</button></div>
          </div>
        </div>
        <div className="article-share flex-auto text-right flex flex-row flex-nowrap justify-end align-center">
          <button>
          ...
          <button className="ml-5">
            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" class="rs" aria-label="Add to list bookmark button"><path d="M18 2.5a.5.5 0 0 1 1 0V5h2.5a.5.5 0 0 1 0 1H19v2.5a.5.5 0 1 1-1 0V6h-2.5a.5.5 0 0 1 0-1H18V2.5zM7 7a1 1 0 0 1 1-1h3.5a.5.5 0 0 0 0-1H8a2 2 0 0 0-2 2v14a.5.5 0 0 0 .8.4l5.7-4.4 5.7 4.4a.5.5 0 0 0 .8-.4v-8.5a.5.5 0 0 0-1 0v7.48l-5.2-4a.5.5 0 0 0-.6 0l-5.2 4V7z" fill="#292929"></path></svg>
          </button>
        </div>
      </div>
    </>
